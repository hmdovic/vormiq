(function () {
  ...
  var state = { key: "start", answers: {}, step: 0, done: false };
  ...
  function buildWidget() {
    ...
    var inputRow = panel.querySelector(".sami-chat-input-row");
    ...
    function updateProgress() {
      var pct = Math.min(100, Math.round((state.step / TOTAL_STEPS) * 100));
      progressBar.style.width = pct + "%";
    }

    function renderStep(isFirst) {
    ...
    function renderDone() {
      ...
      addTyping(function () {
        ...
        restartBtn.addEventListener("click", function () {
          state = { key: "start", answers: {}, step: 0, done: false };
